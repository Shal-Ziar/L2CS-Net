...
def create_scatter_plot(
    ...
    for cal_point in calibration_points:
        ...
        for gaze_result in gaze_results:
            ...
            screen_x, screen_y = gaze_to_screen_coords(
                pitch, yaw, screen_width, screen_height
            )
    ...
    scatter = ax.scatter(gaze_x, gaze_y, c=point_ids, cmap="tab10", s=20, alpha=0.6, label="Captured gaze")
