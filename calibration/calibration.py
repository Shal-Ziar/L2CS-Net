...
from calibration.types import PointState, GazeResultContainer, CalibrationPoint
...
class CalibrationInterface:
    ...
    def __init__(self, fullscreen: bool = True):
        ...
        # Get display info
        display_info = pygame.display.get_info()
    ...
    def _draw_info_text(self) -> None:
        ...
        if not self.calibration_complete:
            ...
            complete_text = self.font_info.render(
                "Calibration Complete! Press ESC to exit.",
                True,
                self.COLOR_GREEN
            )
